...
import { segmentMetaDataList, segmentStaticInputData } from 'gm/app/core/segmentationbuilder/segmentationbuilder.model';
...
export class SegmentationbuilderEditComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        //This code is required to convert the string type data to json format
        //this.segmentData = JSON.parse( this.segmentbuilderService.getSegmentDetail() );
    ...
    retriveUi() {
        if (this.segmentData != null) {
            if (this.segmentData.segments != null) {
                if (this.segmentData.segments.length > 0) {
